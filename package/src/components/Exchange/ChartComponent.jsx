...
},
{
  ...
  function createLightChart() {
    chart.current = createChart(trading_chart.current, {
      ...
      layout: { backgroundColor: "#121413", textColor: "#fff" },
      ...
      upColor: "#2dbd96", downColor: "#DC143C", borderDownColor: "#ff4976", borderUpColor: "#2dbd96", wickDownColor: "#ef5350", wickUpColor: "#2dbd96",
  ...
  return (
    <>
        <div className="chart chrt_tkn_name">
            ...
            <div className="col-md-9 col-lg-9 col-xl-9">
                    {TimelineButtons.map((btn, index) => {
                      return (
                        ...
                        style={{backgroundColor:"var(--box-bg)", fontSize:'var(--fs-14)', fontWeight:"400"}}
              ...
              <div className="col-md-3 col-lg-3 col-xl-3">
                <div className="reset-image text-end">
                     <img color="white" src={ResetImg} onClick={resetLines}/>
                      ...
                      <div className="chrt_time mb-2 ps-3 ps-md-0">
                        {mouseMoveData ? <h6 style={{color : "#FFFFFF", fontSize:"var(--fs-14)", padding:"4px" , fontWeight: "400"}}>
                            {`${symbol} - ${timeParam} `}
                            <span>
                                O
