      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            <div className="text-center py-4 mt-5 feature_box-inner">
              {/* <hr /> */}
             <h1 className="mt-4 mb-3">WHY CHOOSE US</h1>
            </div>
          </div>
        

       
          <div className="card-box col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3">
              ...
              <div className="card p-2 my-3">
                <div className="card-body">
                  ...
                  <p
                    className="card-text"
                  >You can use a mobile device to pay with simple steps.</p>
                </div>
                <div className="card-footer border-0">
                  <div className="feat-img d-flex justify-content-end">
                    <img className="img-fluid" src="./images/home/choose_1.png" alt="choose_1" />
                  </div>
                </div>
              </div>
          ...
          <div className="card-box col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3">
              ...
              <div className="card p-2 my-3">
                <div className="card-body">
                  ...
                  <p
                    className="card-text"
                  >You can buy tokens without paying any transaction fee.</p>
                </div>
                <div className="card-footer border-0">
                  <div className=" feat-img d-flex justify-content-end">
                    <img className="img-fluid" src="./images/home/choose_2.png" alt="choose_2"/>
                  </div>
                </div>
              </div>
          ...
          <div className=" card-box col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3">
              ...
              <div className="card p-2 my-3">
                <div className="card-body">
                  ...
                  <p
                    className="card-text"
                  >If we detect a threat to your identity, we will alert you.</p>
                </div>
                <div className="card-footer border-0">
                  <div className="feat-img d-flex justify-content-end">
                    <img className="img-fluid" src="./images/home/choose_3.png" alt="choose_3" />
                  </div>
                </div>
              </div>
                ...
                <div className=" card-box col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3">
                    ...
                    <div className="card p-2 my-3">
                      <div className="card-body">
                        ...
                        <p
                          className="card-text"
                        >Provide high levels of security allowing the user to keep control money.</p>
                      </div>
                      <div className="card-footer border-0">
                        <div className="feat-img d-flex justify-content-end">
                          <img className="img-fluid" src="./images/home/choose_4.png" alt="choose_4" />
                        </div>
                      </div>
    ...
    {/**choose_sec**/}
      ...
      <div className="container">
        <div className="row justify-content-md-between justify-content-center align-items-center">
          <div className="col-md-6 col-lg-6 order-2 order-md-0">
            <div className="trade-box-inner">
             <hr />
              <h1 className="my-3">
                  Trade Anytime,
                  <br />Anywhere
              ...
              <p className="mb-0">
                  Lorem ipsum dolor sit amet, consectetur adipi eiusmod adipi eiusmod
                  <br />et dolore enim ad
                </p>
          <div className="mt-4">
                    <div className="row align-items-center">
                      <div className="trade_row-box col-md-7 col-lg-6 col-xl-6 ">
                            <div className="trade_row row">
                              <div className="col-12 col-sm-6">
                              <div className=" trade_row-inner  p-3 text-center">
                              <img src="./images/icons/appstoreicon.svg" className="img-fluid " />
                              ...
                              <div className="col-12 col-sm-6">
                              <div className=" trade_row-inner  p-3 text-center">
                              <img src="./images/icons/googleplayicon.svg" className="img-fluid " />
                              <p className="mb-0 mt-3">Google Play</p>
                            </div>
                              </div>
                              <div className="col-12 col-sm-6">
                              <div className=" trade_row-inner  p-3 text-center">
                              <img src="./images/icons/applestoreicon.svg" className="img-fluid " />
                              <p className="mb-0 mt-3 ">Apple Store</p>
                            </div>
                              </div>
                              <div className="col-12 col-sm-6">
                              <div className=" trade_row-inner  p-3 text-center">
                        ...
                        <div className="scan-box d-flex justify-content-center col-md-5 col-lg-5 col-xl-4">
                        <div className="scan ms-md-4 ms-0 mt-md-0 mt-3 d-flex justify-content-center p-3">
                          <img src="./images/home/scanimage.png" className="img-fluid" />
            ...
            <div className="laptop-box col-md-6 col-lg-6">
            <div className="d-flex laptop mt-md-0 mt-5 justify-content-md-end justify-content-center">
              <img src="./images/home/desktop1.png" className="img-fluid" />
              {/* <img src="./public/images/home/tradelaptop.png" className="img-fluid" /> */}
            </div>
          </div>
          </div>
